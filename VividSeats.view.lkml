view: Session_Order_Summary_Raw {
...
#---------------------------------------------------------------------------DIMENSIONS--------------------------------------------------------------------------------------------------#
  ...
  dimension_group: confirmed_cancelled {
    type: time
    hidden: yes
    timeframes: [
      raw
    ...
    convert_tz: no
    datatype: date
    sql: ${TABLE}.confirmedCancelledDate ;;
  }
  ...
  measure: currency
  {
    ...
    sql:  CASE
      ...
      WHEN '{% parameter measure_name %}' = 'buy_fee' then ${buy_fee}
      WHEN '{% parameter measure_name %}' = 'broker_revenue' then ${broker_revenue}
  ...
  measure: Selected_Measure{
    ...
    html:{% case _filters['measure_name']%}
               {% when "gov" %}
